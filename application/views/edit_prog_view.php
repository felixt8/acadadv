...
<div class="intro-content">
	<div class="registration">	
		...
		<form id="formRegister" action ="<?php echo base_url()?>/edit_prog/update/<?php echo $adm->AdmID ?>/<?php echo $prg->PrgID ?>/<?php echo $prg->FacID?>" method ="post" enctype='multipart/form-data'>
