...
<link rel="stylesheet" href="http://localhost/fyproj/public/css/stf_list_css.css">
...
<div class="intro-content">
	<div class="registration">	
		<h3>Staff List</h3>
		<table>
		<tr><td>Staff ID</td><td>Staff Name</td><td>Faculty</td><td></td></tr>
		<?php foreach($STAFF as $stf){?>
        <tr><td><?php echo $stf->StfID?></td><td><?php echo $stf->StfName?></td><td><?php echo $stf->FacName?></td>
        <td class="del"><a href="#" class="del-fac" id="<?php echo $stf->StfID;?>/<?php echo $adm->AdmID?>">Delete</a></td></tr>     
        <?php }?>  
		</table>
