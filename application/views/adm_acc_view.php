...
<link rel="stylesheet" href="http://localhost/fyproj/public/css/adm_acc_css.css">
...
<div class="col-sm-3">
	...
	<?php foreach($ADMIN as $adm){?>
	  ...
	  <div class="sidemenu-content">
		...
		<a href="http://localhost/fyproj/Staff_reg/index/<?php echo $adm->AdmID?>">Staff Registration</a>
		<a href="http://localhost/fyproj/Stf_List/index/<?php echo $adm->AdmID ?>">Staff List</a>
	  </div>
	  <?php }?>
	</div>
</div>
...
<div class="intro-content">
	<div class="registration">	
		<h3>Account Info</h3>
		<form id="formRegister" action ="<?php echo base_url()?>Update_admin/index/<?php echo $adm->AdmID?>" method ="post">
		<?php echo $this->session->flashdata('status'); ?>
		<?php foreach($ADMIN as $adm){?>
		<table>
		<tr><td>Admin ID: </td>
			<td><input type="text" name="id" placeholder="BI17110000" value="<?php echo $adm->AdmID?>" size="50" readonly="readonly"/>
		</td></tr>
		<tr><td><br/></td></tr>
		<tr><td>Password: </td>
			<td><input type="password" name= "password" placeholder="**********" value="<?php echo $adm->AdmPwd?>"size="50"/>
		</td></tr>
		<tr><td><br/></td></tr>
		<tr><td>Name: </td>
			<td><input type="text" name= "name" placeholder="Mohd Ali" value="<?php echo $adm->AdmName?>"size="50"/>
		</td></tr>
		<tr><td><br/></td></tr>
		<tr><td>IC No: </td>
			<td><input type="text" name= "ic" placeholder="980912142563" value="<?php echo $adm->AdmIC?>"size="50"/>
		</td></tr>
		<tr><td><br/></td></tr>
		<tr><td>Email: </td>
			<td><input type="text" name= "email" placeholder="ali@ums.edu.my" value="<?php echo $adm->AdmEmail?>"size="50"/>
		</td></tr>
			<tr><td><br/></td></tr>
		<tr><td></td>
