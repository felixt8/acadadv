...
class SUpdate_faculty extends CI_Controller {
...
function __construct(){
	...
	public function index()
	{
		...
		if($this->form_validation->run()==FALSE){
			...
			$this->session->set_flashdata('facstatus','<div class="alert alert-danger text-center" style="width:600px"> Error! Faculty Name cannot be empty</div>');
			...
			if($result){
				$this->session->set_flashdata('facstatus','<div class="alert alert-success text-center" style="width:600px"> Data Was Update Successfully!</div>');
				...
				$this->session->set_flashdata('facstatus','<div class="alert alert-danger text-center" style="width:600px"> Error Invalid Input! Please Try Again!!</div>');
